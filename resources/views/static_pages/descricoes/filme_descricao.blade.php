        ...
        <div class="container mx-auto px-4 py-16 flex flex-col sm:flex-row ">
            ...
            <div class="md:ml-24">
                ...
                <div class="lg:text-xl mt-5% space-y-3">
                    <h1 for="duração">Duração:  <span>{{ intdiv($filme['runtime'], 60) . ' : ' . $filme['runtime'] % 60 }}</span></h1>
                    <h1 for="pontuação:">Pontuação: <span class="text-yellow-300">{{ $filme['vote_average'] }}</span></h1>
                    <h1 for="data lançamento">Data lançamento: <span>{{ \Carbon\Carbon::parse($filme['release_date'])->format('d/m/Y') }}</span></h1>
                    <div>
