...
@section('content')
    <div class="bg-principal text-white md:h-max min-h-screen">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row ">
            <div class="flex-none">
                <img class="w-64 lg:w-96" src="{{ 'https://image.tmdb.org/t/p/w500/' . $serie['poster_path'] }}"
                    alt="{{ $serie['name'] }}">
            </div>
            <div class="md:ml-24">
                ...
                <div class="lg:text-xl mt-5% space-y-3">
                    ...
                    <h1 for="data lançamento">Data lançamento:
                        <span>{{ \Carbon\Carbon::parse($serie['first_air_date'])->format('d/m/Y') }}</span></h1>
                    <div>
                ...
                <div class="lg:mt-5% text-center ">
                    <span>Qual a sua avaliação para está serie?</span>
            ...
            @guest
            @else
                <form action="{{ route('favoritar_serie', $serie['id']) }}" method="POST">
